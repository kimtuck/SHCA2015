...
function ensureSafeMemberName(name, fullExpression, allowConstructor) {
  ...
  /* -- isecpriv is being removed; it breaks a lot of our code anyway
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
      ...
      $digest: function() {
            ...
            if ((watchers = current.$$watchers)) {
              ...
              while (length--) {
                try {
                    ...
                    /*if (0 <= watcherCount && watcherCount < 100) {
                        console.log('watcher ', watch);
                        value = watch.get(current);
                        last = watch.last;
                        if (_.isObject(value) === false) 
                            console.log("--> ", _.isString(watch.exp) ? watch.exp : '--fn--', value, last);
                        else if (_.isString(watch.exp))
        ...
        //console.log('watches ' + watcherCount)
